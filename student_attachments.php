...
<?php
    ...
    if ($_SESSION['role']!='1') {
      ...
      $sql="SELECT * FROM attachment_request,host,student_request,user WHERE user.id=attachment_request.student AND student_request.id=attachment_request.request AND host.hid=student_request.host  ";
