...
<?php
    ...
    if ($_SESSION['role']!='6') {
      ...
      $sql="SELECT * FROM allocation,attachment_request,user,student_request
    ...
    <section class="content mt-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    ?>
                   <p class="text-dark text-center">Sorry, there are no students assigned to you!</p>
             ...
             <td>
              ...
              <td>
                  <div class="text-center">
                      <a class=" badge bg-orange p-1" href="SingleAllocation.php?id=<?php echo $row['user_id'];?>"><i class="fa fa-user"> View Student</i></a>
