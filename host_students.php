...
<?php
    ...
    if ($_SESSION['role']!='3') {
      ...
      $sql="SELECT * FROM allocation,attachment_request,host,user,student_request,category
      WHERE user.id=attachment_request.student
      and student_request.id=attachment_request.request
      and  host.name='$name'
      and student_request.host=host.hid
      and category.cat_id=student_request.category
      and allocation.attachment=attachment_request.att_id
      and attachment_request.status='Allocated' ";
        ...
        <div class="card">
            ...
            <tr>
             ...
             <td>
              ...
              <?php echo $row['alloc_status']; ?>
              </td>
              <td>
                  <div class="text-center">
                      <a class=" badge bg-orange p-1" href="SingleAllocation.php?id=<?php echo $row['alloc_id'];?>"><i class="fa fa-user"> View Student</i></a>
