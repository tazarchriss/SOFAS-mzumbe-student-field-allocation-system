...
<?php
    ...
    if ($_SESSION['role']!='1') {
      ...
      where `zone_status`='Not Assigned' ";
        ...
        <div class="col-md-10 ">
                ...
                <div class="form-group col-md-12 float-left">
                  ...
                  <div class="form-group col-md-12 float-left">
                        ...
                        <select name="supervisor" class="form-control bg-dark" required>
                            <?php
                                ...
                                while ($result=mysqli_fetch_array($query)) {
                                  ...
                                  $year = date("Y");
                                 $sql="SELECT *  FROM `mu_supervision` WHERE `supervisor`='$id' AND `year`='$year'";
                                  $qry=mysqli_query($conn,$sql);
                                if (mysqli_num_rows($qry)==0) {
                                  # code...
                    ...
                    <button type="submit" name="save" class="btn bg-orange float-right"><i class="fa fa-save"></i> Save Assignment  </button>
