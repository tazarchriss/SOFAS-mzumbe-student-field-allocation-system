...
<?php
    ...
    if ($_SESSION['role']=='') {
      ...
      $sq="SELECT * FROM user,staff,position
      WHERE user.id='$id'
      ...
      $sql="SELECT * FROM user,staff,position,department,school
      WHERE user.role='2'
      AND staff.userId=user.id
      AND position.position_id=staff.position
      AND position.pname='Coordinator'
    ...
    <section class="content">
        ...
        <div class="card">
              ...
              <?php
                    ...
                    ?>
                   <p class="text-dark text-center">Sorry, there are no Programme Coordinators !</p>
