...
<?php
    ...
    if ($_SESSION['role']!='3') {
      ...
      $sql="SELECT * FROM host,user,student_request,category WHERE user.id='$id' and host.name=user.user_id and student_request.host=host.hid and category.cat_id=student_request.category ";
